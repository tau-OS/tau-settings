...
{
  cc_panel_set_title(self, _("Displays"));
                                ...
                                CcDisplayPanel *self)
{
  ...
  cc_panel_set_title(self, "Night Light");
                            ...
                            CcDisplayPanel *self)
{
  ...
  gtk_widget_set_visible(self->back_button, true);
  cc_panel_set_title(self, cc_display_monitor_get_ui_name(monitor));
