...
extern GType cc_firmware_updates_panel_get_type(void);
extern GType cc_fyra_accounts_panel_get_type(void);
...
static CcPanelLoaderVtable default_panels[] =
  ...
  PANEL_TYPE("firmware-updates", cc_firmware_updates_panel_get_type, NULL),
  PANEL_TYPE("fyra-accounts", cc_fyra_accounts_panel_get_type, NULL),
